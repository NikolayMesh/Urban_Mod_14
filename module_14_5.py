...
import asyncio
import TokenBot
from crud_functions import get_all_products, get_title_products, is_included, add_user
...
ki_reg = InlineKeyboardMarkup()
button5 = InlineKeyboardButton( text= 'Регистрация', callback_data='Регистрация')
ki_reg.row(button5)
...
async def start_message(message):
    await message.answer("Привет! Я бот помогающий твоему здоровью.", reply_markup = ki_reg)
